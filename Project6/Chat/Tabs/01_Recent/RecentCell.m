...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	PFUser *lastUser = recent[PF_RECENT_USEROPP];
    
    if(lastUser[PF_USER_THUMBNAIL]) {
        [imageUser setFile:lastUser[PF_USER_THUMBNAIL]];
        [imageUser loadInBackground];
    } else {
        if(lastUser[PF_USER_PICTURE])
            [imageUser setImageWithURL:[NSURL URLWithString:lastUser[PF_USER_PICTURE]]];
    }
